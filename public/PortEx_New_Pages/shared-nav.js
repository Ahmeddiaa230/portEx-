...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.body.insertAdjacentElement('afterbegin', loader.firstElementChild);
    ...
    document.body.insertBefore(navWrapper, bodyFirstChild.nextSibling);
    // Move navbar nodes out of wrapper
    ...
    // Theme toggle (sync with existing logic if present)
    const themeBtn = document.getElementById('navThemeBtn');
    const saved = localStorage.getItem('portex-theme') || 'dark';
    ...
    themeBtn.addEventListener('click', () => {
      ...
      localStorage.setItem('portex-theme', next);
